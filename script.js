...
var moduleBox= document.getElementById('openModal');
...
backBtn.addEventListener('click',(e)=>{
  ...
  var temp=document.getElementsByClassName('mainBox');
  for(let i of temp){
...
var indexDiv = document.querySelector(".indexDiv");
var inputTitle = document.querySelector(".inputText");
var containerBox = document.getElementById("containerMain");
var object = [];
var count = 0;
var plusIcon = [];
var trashIcon = [];
var modal1 = document.querySelector(".hidden2");
...
function addElement1() {
  modal1.classList.remove("hidden2");
  indexDiv.classList.remove("hidden");
}
...
function trashIcon1(id) {
  var temp_box = document.getElementsByClassName('mainBox');
...
document.querySelector(".addBtn").addEventListener("click", () => {
  if (inputTitle.value == "") {
    ...
    boxDiv.classList.add("mainBox", uniqueId); 
